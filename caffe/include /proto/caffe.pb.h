...
class UnpoolingParameter;
class UnpoolingParameterDefaultTypeInternal;
extern UnpoolingParameterDefaultTypeInternal _UnpoolingParameter_default_instance_;
...
enum UnpoolingParameter_UnpoolMethod {
  UnpoolingParameter_UnpoolMethod_MAX = 0,
  UnpoolingParameter_UnpoolMethod_AVE = 1,
  UnpoolingParameter_UnpoolMethod_TILE = 2
};
bool UnpoolingParameter_UnpoolMethod_IsValid(int value);
const UnpoolingParameter_UnpoolMethod UnpoolingParameter_UnpoolMethod_UnpoolMethod_MIN = UnpoolingParameter_UnpoolMethod_MAX;
const UnpoolingParameter_UnpoolMethod UnpoolingParameter_UnpoolMethod_UnpoolMethod_MAX = UnpoolingParameter_UnpoolMethod_TILE;
const int UnpoolingParameter_UnpoolMethod_UnpoolMethod_ARRAYSIZE = UnpoolingParameter_UnpoolMethod_UnpoolMethod_MAX + 1;

const ::google::protobuf::EnumDescriptor* UnpoolingParameter_UnpoolMethod_descriptor();
inline const ::std::string& UnpoolingParameter_UnpoolMethod_Name(UnpoolingParameter_UnpoolMethod value) {
  return ::google::protobuf::internal::NameOfEnum(
    UnpoolingParameter_UnpoolMethod_descriptor(), value);
}
inline bool UnpoolingParameter_UnpoolMethod_Parse(
    const ::std::string& name, UnpoolingParameter_UnpoolMethod* value) {
  return ::google::protobuf::internal::ParseNamedEnum<UnpoolingParameter_UnpoolMethod>(
    UnpoolingParameter_UnpoolMethod_descriptor(), name, value);
}
enum UnpoolingParameter_Engine {
  UnpoolingParameter_Engine_DEFAULT = 0,
  UnpoolingParameter_Engine_CAFFE = 1
};
bool UnpoolingParameter_Engine_IsValid(int value);
const UnpoolingParameter_Engine UnpoolingParameter_Engine_Engine_MIN = UnpoolingParameter_Engine_DEFAULT;
const UnpoolingParameter_Engine UnpoolingParameter_Engine_Engine_MAX = UnpoolingParameter_Engine_CAFFE;
const int UnpoolingParameter_Engine_Engine_ARRAYSIZE = UnpoolingParameter_Engine_Engine_MAX + 1;

const ::google::protobuf::EnumDescriptor* UnpoolingParameter_Engine_descriptor();
inline const ::std::string& UnpoolingParameter_Engine_Name(UnpoolingParameter_Engine value) {
  return ::google::protobuf::internal::NameOfEnum(
    UnpoolingParameter_Engine_descriptor(), value);
}
inline bool UnpoolingParameter_Engine_Parse(
    const ::std::string& name, UnpoolingParameter_Engine* value) {
  return ::google::protobuf::internal::ParseNamedEnum<UnpoolingParameter_Engine>(
    UnpoolingParameter_Engine_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  // optional .caffe.UnpoolingParameter unpooling_param = 147;
  bool has_unpooling_param() const;
  void clear_unpooling_param();
  static const int kUnpoolingParamFieldNumber = 147;
  const ::caffe::UnpoolingParameter& unpooling_param() const;
  ::caffe::UnpoolingParameter* mutable_unpooling_param();
  ::caffe::UnpoolingParameter* release_unpooling_param();
  void set_allocated_unpooling_param(::caffe::UnpoolingParameter* unpooling_param);
 ...
 private:
  ...
  void set_has_unpooling_param();
  void clear_has_unpooling_param();
  ...
  ::caffe::UnpoolingParameter* unpooling_param_;
...
class CropParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.CropParameter) */ {
 public:
  ...
  ::google::protobuf::uint32 size(int index) const;
  void set_size(int index, ::google::protobuf::uint32 value);
  void add_size(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      size() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_size();
...
class PoolingParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.PoolingParameter) */ {
 public:
  ...
  // optional bool remove_extra = 13 [default = false];
  bool has_remove_extra() const;
  void clear_remove_extra();
  static const int kRemoveExtraFieldNumber = 13;
  bool remove_extra() const;
  void set_remove_extra(bool value);
 ...
 private:
  ...
  void set_has_remove_extra();
  void clear_has_remove_extra();
...
class UnpoolingParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.UnpoolingParameter) */ {
 public:
  UnpoolingParameter();
  virtual ~UnpoolingParameter();

  UnpoolingParameter(const UnpoolingParameter& from);

  inline UnpoolingParameter& operator=(const UnpoolingParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const UnpoolingParameter& default_instance();

  static inline const UnpoolingParameter* internal_default_instance() {
    return reinterpret_cast<const UnpoolingParameter*>(
               &_UnpoolingParameter_default_instance_);
  }

  void Swap(UnpoolingParameter* other);

  // implements Message ----------------------------------------------

  inline UnpoolingParameter* New() const PROTOBUF_FINAL { return New(NULL); }

  UnpoolingParameter* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const UnpoolingParameter& from);
  void MergeFrom(const UnpoolingParameter& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(UnpoolingParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef UnpoolingParameter_UnpoolMethod UnpoolMethod;
  static const UnpoolMethod MAX =
    UnpoolingParameter_UnpoolMethod_MAX;
  static const UnpoolMethod AVE =
    UnpoolingParameter_UnpoolMethod_AVE;
  static const UnpoolMethod TILE =
    UnpoolingParameter_UnpoolMethod_TILE;
  static inline bool UnpoolMethod_IsValid(int value) {
    return UnpoolingParameter_UnpoolMethod_IsValid(value);
  }
  static const UnpoolMethod UnpoolMethod_MIN =
    UnpoolingParameter_UnpoolMethod_UnpoolMethod_MIN;
  static const UnpoolMethod UnpoolMethod_MAX =
    UnpoolingParameter_UnpoolMethod_UnpoolMethod_MAX;
  static const int UnpoolMethod_ARRAYSIZE =
    UnpoolingParameter_UnpoolMethod_UnpoolMethod_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  UnpoolMethod_descriptor() {
    return UnpoolingParameter_UnpoolMethod_descriptor();
  }
  static inline const ::std::string& UnpoolMethod_Name(UnpoolMethod value) {
    return UnpoolingParameter_UnpoolMethod_Name(value);
  }
  static inline bool UnpoolMethod_Parse(const ::std::string& name,
      UnpoolMethod* value) {
    return UnpoolingParameter_UnpoolMethod_Parse(name, value);
  }

  typedef UnpoolingParameter_Engine Engine;
  static const Engine DEFAULT =
    UnpoolingParameter_Engine_DEFAULT;
  static const Engine CAFFE =
    UnpoolingParameter_Engine_CAFFE;
  static inline bool Engine_IsValid(int value) {
    return UnpoolingParameter_Engine_IsValid(value);
  }
  static const Engine Engine_MIN =
    UnpoolingParameter_Engine_Engine_MIN;
  static const Engine Engine_MAX =
    UnpoolingParameter_Engine_Engine_MAX;
  static const int Engine_ARRAYSIZE =
    UnpoolingParameter_Engine_Engine_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Engine_descriptor() {
    return UnpoolingParameter_Engine_descriptor();
  }
  static inline const ::std::string& Engine_Name(Engine value) {
    return UnpoolingParameter_Engine_Name(value);
  }
  static inline bool Engine_Parse(const ::std::string& name,
      Engine* value) {
    return UnpoolingParameter_Engine_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.UnpoolingParameter.UnpoolMethod unpool = 1 [default = MAX];
  bool has_unpool() const;
  void clear_unpool();
  static const int kUnpoolFieldNumber = 1;
  ::caffe::UnpoolingParameter_UnpoolMethod unpool() const;
  void set_unpool(::caffe::UnpoolingParameter_UnpoolMethod value);
  ...
  // optional uint32 unpool_size = 12;
  bool has_unpool_size() const;
  void clear_unpool_size();
  static const int kUnpoolSizeFieldNumber = 12;
  ::google::protobuf::uint32 unpool_size() const;
  void set_unpool_size(::google::protobuf::uint32 value);

  // optional uint32 unpool_h = 13;
  bool has_unpool_h() const;
  void clear_unpool_h();
  static const int kUnpoolHFieldNumber = 13;
  ::google::protobuf::uint32 unpool_h() const;
  void set_unpool_h(::google::protobuf::uint32 value);

  // optional uint32 unpool_w = 14;
  bool has_unpool_w() const;
  void clear_unpool_w();
  static const int kUnpoolWFieldNumber = 14;
  ::google::protobuf::uint32 unpool_w() const;
  void set_unpool_w(::google::protobuf::uint32 value);

  // optional .caffe.UnpoolingParameter.Engine engine = 11 [default = DEFAULT];
  bool has_engine() const;
  void clear_engine();
  static const int kEngineFieldNumber = 11;
  ::caffe::UnpoolingParameter_Engine engine() const;
  void set_engine(::caffe::UnpoolingParameter_Engine value);
 ...
 private:
  ...
  void set_has_stride_w();
  void clear_has_stride_w();
  void set_has_unpool_size();
  void clear_has_unpool_size();
  void set_has_unpool_h();
  void clear_has_unpool_h();
  void set_has_unpool_w();
  void clear_has_unpool_w();
  void set_has_engine();
  void clear_has_engine();
  ...
  ::google::protobuf::uint32 stride_h_;
  ::google::protobuf::uint32 stride_w_;
  ::google::protobuf::uint32 unpool_size_;
  ::google::protobuf::uint32 unpool_h_;
  ::google::protobuf::uint32 unpool_w_;
  int engine_;
  ::google::protobuf::uint32 stride_;
  friend struct  protobuf_src_2fcaffe_2fproto_2fcaffe_2eproto::TableStruct;
};
...
// optional .caffe.UnpoolingParameter unpooling_param = 147;
inline bool LayerParameter::has_unpooling_param() const {
  return (_has_bits_[1] & 0x00010000u) != 0;
}
inline void LayerParameter::set_has_unpooling_param() {
  _has_bits_[1] |= 0x00010000u;
}
inline void LayerParameter::clear_has_unpooling_param() {
  _has_bits_[1] &= ~0x00010000u;
}
inline void LayerParameter::clear_unpooling_param() {
  if (unpooling_param_ != NULL) unpooling_param_->::caffe::UnpoolingParameter::Clear();
  clear_has_unpooling_param();
}
inline const ::caffe::UnpoolingParameter& LayerParameter::unpooling_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.unpooling_param)
  return unpooling_param_ != NULL ? *unpooling_param_
                         : *::caffe::UnpoolingParameter::internal_default_instance();
}
inline ::caffe::UnpoolingParameter* LayerParameter::mutable_unpooling_param() {
  set_has_unpooling_param();
  if (unpooling_param_ == NULL) {
    unpooling_param_ = new ::caffe::UnpoolingParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.unpooling_param)
  return unpooling_param_;
}
inline ::caffe::UnpoolingParameter* LayerParameter::release_unpooling_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.unpooling_param)
  clear_has_unpooling_param();
  ::caffe::UnpoolingParameter* temp = unpooling_param_;
  unpooling_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_unpooling_param(::caffe::UnpoolingParameter* unpooling_param) {
  delete unpooling_param_;
  unpooling_param_ = unpooling_param;
  if (unpooling_param) {
    set_has_unpooling_param();
  } else {
    clear_has_unpooling_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.unpooling_param)
}
...
// repeated uint32 size = 3;
inline int CropParameter::size_size() const {
  return size_.size();
}
inline void CropParameter::clear_size() {
  size_.Clear();
}
inline ::google::protobuf::uint32 CropParameter::size(int index) const {
  // @@protoc_insertion_point(field_get:caffe.CropParameter.size)
  return size_.Get(index);
}
inline void CropParameter::set_size(int index, ::google::protobuf::uint32 value) {
  size_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.CropParameter.size)
}
inline void CropParameter::add_size(::google::protobuf::uint32 value) {
  size_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.CropParameter.size)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
CropParameter::size() const {
  // @@protoc_insertion_point(field_list:caffe.CropParameter.size)
  return size_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
CropParameter::mutable_size() {
  // @@protoc_insertion_point(field_mutable_list:caffe.CropParameter.size)
  return &size_;
}
...
// optional bool remove_extra = 13 [default = false];
inline bool PoolingParameter::has_remove_extra() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void PoolingParameter::set_has_remove_extra() {
  _has_bits_[0] |= 0x00000800u;
}
inline void PoolingParameter::clear_has_remove_extra() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void PoolingParameter::clear_remove_extra() {
  remove_extra_ = false;
  clear_has_remove_extra();
}
inline bool PoolingParameter::remove_extra() const {
  // @@protoc_insertion_point(field_get:caffe.PoolingParameter.remove_extra)
  return remove_extra_;
}
inline void PoolingParameter::set_remove_extra(bool value) {
  set_has_remove_extra();
  remove_extra_ = value;
  // @@protoc_insertion_point(field_set:caffe.PoolingParameter.remove_extra)
}
...
// optional .caffe.UnpoolingParameter.UnpoolMethod unpool = 1 [default = MAX];
inline bool UnpoolingParameter::has_unpool() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void UnpoolingParameter::set_has_unpool() {
  _has_bits_[0] |= 0x00000001u;
}
inline void UnpoolingParameter::clear_has_unpool() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void UnpoolingParameter::clear_unpool() {
  unpool_ = 0;
  clear_has_unpool();
}
inline ::caffe::UnpoolingParameter_UnpoolMethod UnpoolingParameter::unpool() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.unpool)
  return static_cast< ::caffe::UnpoolingParameter_UnpoolMethod >(unpool_);
}
inline void UnpoolingParameter::set_unpool(::caffe::UnpoolingParameter_UnpoolMethod value) {
  assert(::caffe::UnpoolingParameter_UnpoolMethod_IsValid(value));
  set_has_unpool();
  unpool_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.unpool)
}

// optional uint32 pad = 4 [default = 0];
inline bool UnpoolingParameter::has_pad() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void UnpoolingParameter::set_has_pad() {
  _has_bits_[0] |= 0x00000002u;
}
inline void UnpoolingParameter::clear_has_pad() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void UnpoolingParameter::clear_pad() {
  pad_ = 0u;
  clear_has_pad();
}
inline ::google::protobuf::uint32 UnpoolingParameter::pad() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.pad)
  return pad_;
}
inline void UnpoolingParameter::set_pad(::google::protobuf::uint32 value) {
  set_has_pad();
  pad_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.pad)
}

// optional uint32 pad_h = 9 [default = 0];
inline bool UnpoolingParameter::has_pad_h() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void UnpoolingParameter::set_has_pad_h() {
  _has_bits_[0] |= 0x00000004u;
}
inline void UnpoolingParameter::clear_has_pad_h() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void UnpoolingParameter::clear_pad_h() {
  pad_h_ = 0u;
  clear_has_pad_h();
}
inline ::google::protobuf::uint32 UnpoolingParameter::pad_h() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.pad_h)
  return pad_h_;
}
inline void UnpoolingParameter::set_pad_h(::google::protobuf::uint32 value) {
  set_has_pad_h();
  pad_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.pad_h)
}

// optional uint32 pad_w = 10 [default = 0];
inline bool UnpoolingParameter::has_pad_w() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void UnpoolingParameter::set_has_pad_w() {
  _has_bits_[0] |= 0x00000008u;
}
inline void UnpoolingParameter::clear_has_pad_w() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void UnpoolingParameter::clear_pad_w() {
  pad_w_ = 0u;
  clear_has_pad_w();
}
inline ::google::protobuf::uint32 UnpoolingParameter::pad_w() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.pad_w)
  return pad_w_;
}
inline void UnpoolingParameter::set_pad_w(::google::protobuf::uint32 value) {
  set_has_pad_w();
  pad_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.pad_w)
}

// optional uint32 kernel_size = 2;
inline bool UnpoolingParameter::has_kernel_size() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void UnpoolingParameter::set_has_kernel_size() {
  _has_bits_[0] |= 0x00000010u;
}
inline void UnpoolingParameter::clear_has_kernel_size() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void UnpoolingParameter::clear_kernel_size() {
  kernel_size_ = 0u;
  clear_has_kernel_size();
}
inline ::google::protobuf::uint32 UnpoolingParameter::kernel_size() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.kernel_size)
  return kernel_size_;
}
inline void UnpoolingParameter::set_kernel_size(::google::protobuf::uint32 value) {
  set_has_kernel_size();
  kernel_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.kernel_size)
}

// optional uint32 kernel_h = 5;
inline bool UnpoolingParameter::has_kernel_h() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void UnpoolingParameter::set_has_kernel_h() {
  _has_bits_[0] |= 0x00000020u;
}
inline void UnpoolingParameter::clear_has_kernel_h() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void UnpoolingParameter::clear_kernel_h() {
  kernel_h_ = 0u;
  clear_has_kernel_h();
}
inline ::google::protobuf::uint32 UnpoolingParameter::kernel_h() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.kernel_h)
  return kernel_h_;
}
inline void UnpoolingParameter::set_kernel_h(::google::protobuf::uint32 value) {
  set_has_kernel_h();
  kernel_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.kernel_h)
}

// optional uint32 kernel_w = 6;
inline bool UnpoolingParameter::has_kernel_w() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void UnpoolingParameter::set_has_kernel_w() {
  _has_bits_[0] |= 0x00000040u;
}
inline void UnpoolingParameter::clear_has_kernel_w() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void UnpoolingParameter::clear_kernel_w() {
  kernel_w_ = 0u;
  clear_has_kernel_w();
}
inline ::google::protobuf::uint32 UnpoolingParameter::kernel_w() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.kernel_w)
  return kernel_w_;
}
inline void UnpoolingParameter::set_kernel_w(::google::protobuf::uint32 value) {
  set_has_kernel_w();
  kernel_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.kernel_w)
}

// optional uint32 stride = 3 [default = 1];
inline bool UnpoolingParameter::has_stride() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void UnpoolingParameter::set_has_stride() {
  _has_bits_[0] |= 0x00002000u;
}
inline void UnpoolingParameter::clear_has_stride() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void UnpoolingParameter::clear_stride() {
  stride_ = 1u;
  clear_has_stride();
}
inline ::google::protobuf::uint32 UnpoolingParameter::stride() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.stride)
  return stride_;
}
inline void UnpoolingParameter::set_stride(::google::protobuf::uint32 value) {
  set_has_stride();
  stride_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.stride)
}

// optional uint32 stride_h = 7;
inline bool UnpoolingParameter::has_stride_h() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void UnpoolingParameter::set_has_stride_h() {
  _has_bits_[0] |= 0x00000080u;
}
inline void UnpoolingParameter::clear_has_stride_h() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void UnpoolingParameter::clear_stride_h() {
  stride_h_ = 0u;
  clear_has_stride_h();
}
inline ::google::protobuf::uint32 UnpoolingParameter::stride_h() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.stride_h)
  return stride_h_;
}
inline void UnpoolingParameter::set_stride_h(::google::protobuf::uint32 value) {
  set_has_stride_h();
  stride_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.stride_h)
}

// optional uint32 stride_w = 8;
inline bool UnpoolingParameter::has_stride_w() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void UnpoolingParameter::set_has_stride_w() {
  _has_bits_[0] |= 0x00000100u;
}
inline void UnpoolingParameter::clear_has_stride_w() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void UnpoolingParameter::clear_stride_w() {
  stride_w_ = 0u;
  clear_has_stride_w();
}
inline ::google::protobuf::uint32 UnpoolingParameter::stride_w() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.stride_w)
  return stride_w_;
}
inline void UnpoolingParameter::set_stride_w(::google::protobuf::uint32 value) {
  set_has_stride_w();
  stride_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.stride_w)
}

// optional uint32 unpool_size = 12;
inline bool UnpoolingParameter::has_unpool_size() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void UnpoolingParameter::set_has_unpool_size() {
  _has_bits_[0] |= 0x00000200u;
}
inline void UnpoolingParameter::clear_has_unpool_size() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void UnpoolingParameter::clear_unpool_size() {
  unpool_size_ = 0u;
  clear_has_unpool_size();
}
inline ::google::protobuf::uint32 UnpoolingParameter::unpool_size() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.unpool_size)
  return unpool_size_;
}
inline void UnpoolingParameter::set_unpool_size(::google::protobuf::uint32 value) {
  set_has_unpool_size();
  unpool_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.unpool_size)
}

// optional uint32 unpool_h = 13;
inline bool UnpoolingParameter::has_unpool_h() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void UnpoolingParameter::set_has_unpool_h() {
  _has_bits_[0] |= 0x00000400u;
}
inline void UnpoolingParameter::clear_has_unpool_h() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void UnpoolingParameter::clear_unpool_h() {
  unpool_h_ = 0u;
  clear_has_unpool_h();
}
inline ::google::protobuf::uint32 UnpoolingParameter::unpool_h() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.unpool_h)
  return unpool_h_;
}
inline void UnpoolingParameter::set_unpool_h(::google::protobuf::uint32 value) {
  set_has_unpool_h();
  unpool_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.unpool_h)
}

// optional uint32 unpool_w = 14;
inline bool UnpoolingParameter::has_unpool_w() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void UnpoolingParameter::set_has_unpool_w() {
  _has_bits_[0] |= 0x00000800u;
}
inline void UnpoolingParameter::clear_has_unpool_w() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void UnpoolingParameter::clear_unpool_w() {
  unpool_w_ = 0u;
  clear_has_unpool_w();
}
inline ::google::protobuf::uint32 UnpoolingParameter::unpool_w() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.unpool_w)
  return unpool_w_;
}
inline void UnpoolingParameter::set_unpool_w(::google::protobuf::uint32 value) {
  set_has_unpool_w();
  unpool_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.unpool_w)
}

// optional .caffe.UnpoolingParameter.Engine engine = 11 [default = DEFAULT];
inline bool UnpoolingParameter::has_engine() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void UnpoolingParameter::set_has_engine() {
  _has_bits_[0] |= 0x00001000u;
}
inline void UnpoolingParameter::clear_has_engine() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void UnpoolingParameter::clear_engine() {
  engine_ = 0;
  clear_has_engine();
}
inline ::caffe::UnpoolingParameter_Engine UnpoolingParameter::engine() const {
  // @@protoc_insertion_point(field_get:caffe.UnpoolingParameter.engine)
  return static_cast< ::caffe::UnpoolingParameter_Engine >(engine_);
}
inline void UnpoolingParameter::set_engine(::caffe::UnpoolingParameter_Engine value) {
  assert(::caffe::UnpoolingParameter_Engine_IsValid(value));
  set_has_engine();
  engine_ = value;
  // @@protoc_insertion_point(field_set:caffe.UnpoolingParameter.engine)
}
...
template <> struct is_proto_enum< ::caffe::UnpoolingParameter_UnpoolMethod> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::UnpoolingParameter_UnpoolMethod>() {
  return ::caffe::UnpoolingParameter_UnpoolMethod_descriptor();
}
template <> struct is_proto_enum< ::caffe::UnpoolingParameter_Engine> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::UnpoolingParameter_Engine>() {
  return ::caffe::UnpoolingParameter_Engine_descriptor();
}
